...
`define Func_Bltz 6'b00_0000
`define Func_Bgez 6'b00_0001

`define Func_Jalr 6'b00_1001
`define Func_Jr 6'b00_1000

`define Func_Syscall 6'b00_1100
`define Func_Eret 6'b01_1000
`define Func_Mfc0 6'b00_0000
`define Func_Mtc0 6'b00_0000
